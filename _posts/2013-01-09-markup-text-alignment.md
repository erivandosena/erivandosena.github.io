---
title: "Markup: Alinhamento e Transformações de Texto"
categories:
  - Markup
tags:
  - alignment
...
Texto de amostra para demonstrar classes de alinhamento e transformação.

Realinhe facilmente o texto com classes de alinhamento via HTML:
...
Ou com Kramdown e [listas de atributos inline](https://kramdown.gettalong.org/syntax.html#inline-attribute-lists):
...
Transforme texto com classes de capitalização via HTML:
