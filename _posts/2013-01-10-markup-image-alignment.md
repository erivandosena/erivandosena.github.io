---
title: "Markup: Alinhamento de Imagem"
categories:
  - Markup
tags:
  - alignment
...
A melhor maneira de demonstrar o fluxo e refluxo das várias opções de posicionamento de imagem é aninhá-las confortavelmente entre um oceano de palavras. Pegue uma raquete e vamos começar.

Atribuir classes com HTML:
...
Ou use Kramdown e [listas de atributos inline](https://kramdown.gettalong.org/syntax.html#inline-attribute-lists):
...
A imagem deve ser **centralizada** com a classe `.align-center`.
...
A figura acima está **centralizada**. A legenda também tem um link, só para ver se faz algo estranho.
